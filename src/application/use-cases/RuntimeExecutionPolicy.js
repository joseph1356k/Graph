function buildRuntimeDecisionPrompt() {
  return [
    ...
    'For select steps, first infer the semantic choice requested by currentExecutionIntent, then choose one option from currentPage.pageSnapshot selects or controls only.',
    ...
    'If currentExecutionIntent.stepVariable is present, it represents the active request for the current step. Its metadata can explain the learned value, but the selectedValue you return must be a currentPage option value.',
