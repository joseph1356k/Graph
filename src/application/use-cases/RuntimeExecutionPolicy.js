function buildRuntimeDecisionPrompt() {
  return [
    ...
    'For select steps, choose values only from the current pageSnapshot select options. Prefer semantic meaning over learned numeric values or option position.',
